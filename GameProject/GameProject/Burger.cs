    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, /*MouseState mouse*/ KeyboardState keyboard)
        {
            ...
            if (this.Health > 0)
            {
                ...
                {
                    drawRectangle.X = GameConstants.WINDOW_WIDTH - sprite.Width; // drawRectangle.Width
                }
                ...
                {
                    drawRectangle.Y = GameConstants.WINDOW_HEIGHT - sprite.Height;//drawRectangle.Height
                }
                ...
                if (!canShoot)
                {
                    ...
                    if (elapsedCooldownTime >= GameConstants.BURGER_COOLDOWN_MILLISECONDS
                        || /*mouse.LeftButton == ButtonState.Released*/ !keyboard.IsKeyDown(Keys.Space))  //correct??
                    {
                        canShoot = true;
                ...
                if (health>0&&/*mouse.LeftButton == ButtonState.Pressed*/ keyboard.IsKeyDown (Keys.Space )&&canShoot)
                {
                    canShoot = false;
                    Projectile projectile = new Projectile(ProjectileType.FrenchFries,
                           ...
                           ,-GameConstants .FRENCH_FRIES_PROJECTILE_SPEED ); //here is difficult
