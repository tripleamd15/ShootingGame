    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // add initial game objects
             burger = new Burger(Content, "burger", graphics.PreferredBackBufferWidth / 2,
                          graphics.PreferredBackBufferHeight * 7 / 8, burgerShot);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            for (int i = 0; i < bears.Count; i++)
            {
                for (int j = i+1; j < bears.Count; j++)
                {
                    if (bears[i].Active &&bears [j].Active )
                    {
                        ...
                        //upon bear collision, play bounce sound and update bear velocity and location
            ...
            foreach (TeddyBear  bear in bears)
            {
                ...
                {
                    bear.Active = false;
                    explosions.Add(new Explosion(explosionSpriteStrip, bear.DrawRectangle.Center.X,
                                                    bear.DrawRectangle.Center.Y,explosion ));
                    //burger taking damage and health display
            ...
            //spawn new bear upon one damaged
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, scoreString, GameConstants.SCORE_LOCATION, Color.DarkBlue);
        ...
        public static Texture2D GetProjectileSprite(ProjectileType type)
        {
            ...
            else if (type.ToString ()=="TeddyBear")
            {
        ...
        private void SpawnBear()
        {
            ...
            TeddyBear newBear = new TeddyBear(Content, "teddybear",
                 x, y, velocity, teddyBounce, teddyShot);

                // make sure we don't spawn into a collision
               List<Rectangle> objectCollisionRetangles=GetCollisionRectangles();
               while (!CollisionUtils.IsCollisionFree(newBear.DrawRectangle, objectCollisionRetangles))
               {
        ...
        {
            if (burger.Health==00 && !burgerDead)
            {
                burgerDead = true;
                burgerDeath.Play();
            }
